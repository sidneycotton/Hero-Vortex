...
const sounds={tap:()=>tone({freq:520,endFreq:410,duration:.045,type:'sine',volume:.25}),select:()=>tone({freq:460,endFreq:700,duration:.09,type:'triangle',volume:.3}),attack:()=>{noise({duration:.09,volume:.28,filter:1200});tone({freq:170,endFreq:65,duration:.13,type:'sawtooth',volume:.3})},impact:()=>{noise({duration:.11,volume:.48,filter:700});tone({freq:95,endFreq:45,duration:.16,type:'square',volume:.2})},heal:()=>{tone({freq:420,endFreq:680,duration:.18,type:'sine',volume:.28});tone({freq:620,endFreq:900,duration:.2,type:'sine',volume:.18,delay:.07})},shield:()=>{tone({freq:260,endFreq:520,duration:.2,type:'triangle',volume:.25});tone({freq:780,endFreq:520,duration:.18,type:'sine',volume:.12,delay:.06})},status:()=>{tone({freq:300,endFreq:170,duration:.16,type:'triangle',volume:.18});tone({freq:560,endFreq:400,duration:.2,type:'sine',volume:.12,delay:.04})},buff:()=>{tone({freq:360,endFreq:760,duration:.22,type:'triangle',volume:.2});tone({freq:720,endFreq:980,duration:.18,type:'sine',volume:.1,delay:.08})},summon:()=>{tone({freq:180,endFreq:420,duration:.24,type:'sine',volume:.18});tone({freq:520,endFreq:760,duration:.18,type:'triangle',volume:.12,delay:.1})},field:()=>{tone({freq:120,endFreq:70,duration:.35,type:'sine',volume:.14});tone({freq:330,endFreq:180,duration:.28,type:'triangle',volume:.13,delay:.08})},taunt:()=>{tone({freq:140,endFreq:90,duration:.24,type:'sawtooth',volume:.18});noise({duration:.08,volume:.16,filter:500,delay:.03})},sacrifice:()=>tone({freq:240,endFreq:55,duration:.3,type:'sawtooth',volume:.2}),revive:()=>{tone({freq:190,endFreq:560,duration:.35,type:'sine',volume:.2});tone({freq:560,endFreq:820,duration:.2,type:'triangle',volume:.1,delay:.12})},defeat:()=>{tone({freq:190,endFreq:65,duration:.35,type:'sawtooth',volume:.28});noise({duration:.2,volume:.18,filter:500,delay:.04})},target:()=>tone({freq:720,endFreq:980,duration:.065,type:'triangle',volume:.2})};
