...
const UNIT_CHARACTER_FILES = ['andressa','ajax','yvrel','mariana','babawibby','daxen_ciris','amelia','maquina_de_guerra','moldar','sirius','carmelita_marquese','gavin','dario','porteiro'];
const MODEL_CHARACTER_FILES = ['andressa','ajax','yvrel','gavin','daxen_ciris','mariana','amelia','moldar','babawibby','maquina_de_guerra','sirius','carmelita_marquese','dario','porteiro','dario_shadow','election_mob'];
